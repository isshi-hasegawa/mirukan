...
4. review 指摘または CI 失敗を取得する
5. 項目を `修正する / 説明する / 見送る` に分類する
6. 影響範囲ごとに変更をまとめて実装する
7. `AGENTS.md` に従って必要な検証を実行する
8. [`self-review`](../self-review/SKILL.md) で差分と検証結果を点検する
9. コミットし、必要なら push する
10. 必要時のみ [`pr-open`](../pr-open/SKILL.md) や review reply に進む
