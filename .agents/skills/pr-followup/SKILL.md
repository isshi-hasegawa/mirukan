...
- [pr-open](../pr-open/SKILL.md) → **pr-followup**
- 修正後は [self-review](../self-review/SKILL.md) を実施し、必要なら [adversarial-review](../adversarial-review/SKILL.md) を追加してから [pr-open](../pr-open/SKILL.md) で本文を補正する
...
11. 必要時のみ [`pr-open`](../pr-open/SKILL.md) や review reply に進む
