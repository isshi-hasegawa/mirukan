...
2. ローカル / リモート / 既存 PR の状態を確認する
3. 必要なら branch を push する
4. base branch と `HEAD` の差分、コミット履歴を読む
5. テンプレートに沿ってタイトルと本文を生成する
6. GitHub MCP を優先して PR を作成または更新する
7. 差分とのズレがないか確認して結果を報告する
