...
- GitHub Issue URL / 番号が起点の作業では、Issue 本文と全コメントを確認し、コメント反映後の確定スコープを整理してから branch を切る
...
3. GitHub Issue URL / 番号が起点なら、Issue 本文と全コメントを確認し、「Issue 本文の要点」と「コメント反映後の確定スコープ」を整理する
