...
3. `main` を最新化した後に、`feat/...` `fix/...` `chore/...` `docs/...` `refactor/...` `test/...` `ci/...` などの種別を先頭に付けた作業ブランチを作成する。
4. Issue がある作業では `type/<issue-number>-<slug>`、Issue がない作業では `type/<slug>` の形式を使う。
5. `AGENTS.md` と作業対象を確認してから編集を始める。
