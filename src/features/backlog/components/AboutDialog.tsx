        ...
        <div className="grid gap-5 text-sm leading-7 text-muted-foreground">
          ...
          <section className="grid gap-2 rounded-[20px] border border-[rgba(191,90,54,0.2)] bg-[rgba(191,90,54,0.07)] p-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex w-fit items-center rounded-full border border-border px-3 py-1.5 text-sm font-medium text-foreground transition-colors hover:border-primary hover:text-primary"
            >
              TMDB
            </a>
          </section>
